...
do
    ...
    sed -i $SED_EXTRA_ARGS "s?{{INTACCT_AUTHORIZE_URI}}?${INTACCT_AUTHORIZE_URI}?g" $f;
    sed -i $SED_EXTRA_ARGS "s?{{INTACCT_OAUTH_CLIENT_ID}}?${INTACCT_OAUTH_CLIENT_ID}?g" $f;
    sed -i $SED_EXTRA_ARGS "s?{{INTACCT_OAUTH_REDIRECT_URI}}?${INTACCT_OAUTH_REDIRECT_URI}?g" $f;
done
