...
do
    ...
    sed -i $SED_EXTRA_ARGS "s?{{REFINER_SAGE50_ONBOARDING_DONE_SURVEY_ID}}?${REFINER_SAGE50_ONBOARDING_DONE_SURVEY_ID}?g" $f;
    sed -i $SED_EXTRA_ARGS "s?{{REFINER_SAGE50_EXPORT_DONE_SURVEY_ID}}?${REFINER_SAGE50_EXPORT_DONE_SURVEY_ID}?g" $f;
