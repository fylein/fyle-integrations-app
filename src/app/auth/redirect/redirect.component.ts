  ...
  private setupNavigation(): void {
    if (this.route.snapshot.queryParams?.state) {
      if (this.route.snapshot.queryParams?.state.includes('travelperk_local_redirect')) {
        ...
        this.route.snapshot.queryParams?.state === 'qbo_local_redirect' ||
        this.route.snapshot.queryParams?.state === 'business_central_local_redirect' ||
        this.route.snapshot.queryParams?.state === 'xero_local_redirect'
      ) {
