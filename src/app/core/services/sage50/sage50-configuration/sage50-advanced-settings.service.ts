...
import { Sage50AdvancedSettings, Sage50AdvancedSettingsForm, Sage50LineLevelMemoOption, Sage50TopLevelMemoOption } from "src/app/core/models/sage50/sage50-configuration/sage50-advanced-settings.model";
...
export class Sage50AdvancedSettingsService extends AdvancedSettingsService {
    ...
    getSage50AdvancedSettings(): Observable<Sage50AdvancedSettings | null> {
        return this.apiService.get(`/${this.workspaceService.getWorkspaceId()}/settings/advanced_settings/`, {}).pipe(
            catchError(() => of(null))
        );
    }
    ...
    mapAPIResponseToFormGroup(advancedSettings: Sage50AdvancedSettings | null): FormGroup<Sage50AdvancedSettingsForm> {
