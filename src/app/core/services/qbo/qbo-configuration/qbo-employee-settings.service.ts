...
export class QboEmployeeSettingsService {
    ...
    return [
      {
        ...
        label: this.translocoService.translate('services.qboEmployeeSettings.nameToQboDisplayName', {
          brandName: brandingConfig.brandName,
        }),
      },
      {
        value: AutoMapEmployeeOptions.EMAIL,
        label: this.translocoService.translate('services.qboEmployeeSettings.emailToQboEmail', {
          brandName: brandingConfig.brandName,
        }),
      },
      {
        value: AutoMapEmployeeOptions.EMPLOYEE_CODE,
        label: this.translocoService.translate('services.qboEmployeeSettings.employeeCodeToQboDisplayName', {
          brandName: brandingConfig.brandName,
        }),
      },
    ];
  ...
  postEmployeeSettings(employeeSettingsPayload: QBOEmployeeSettingPost): Observable<QBOEmployeeSettingGet> {
    return this.apiService.put(
      `/v2/workspaces/${this.workspaceService.getWorkspaceId()}/map_employees/`,
