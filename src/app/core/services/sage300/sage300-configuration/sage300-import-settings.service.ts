...
export class Sage300ImportSettingsService extends ImportSettingsService {
  ...
  static mapAPIResponseToFormGroup(importSettings: Sage300ImportSettingGet | null, sage300Fields: IntegrationField[], importCodeFieldConfig: ImportCodeFieldConfigType): FormGroup {
      ...
      return new FormGroup({
          ...
          costCategory: new FormControl(importSettings?.dependent_field_settings?.cost_category_field_name ? Sage300ImportSettingsService.generateDependentFieldValue(importSettings.dependent_field_settings.cost_category_field_name, importSettings.dependent_field_settings.cost_category_placeholder) : null),
