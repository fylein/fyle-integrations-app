...
export class HelperUtility {
  ...
  static clearValidatorAndResetValue(form: FormGroup, controllerName: string): void {
    ...
    if (
      controllerName !== 'accountsPayable' &&
      controllerName !== 'defaultCCCAccount' &&
      controllerName !== 'bankAccount' &&
      controllerName !== 'creditCardAccount' &&
      controllerName !== 'defaultDebitCardAccount' &&
      controllerName !== 'defaultCreditCardVendor' &&
      controllerName !== 'nameInJournalEntry' &&
      controllerName !== 'exportScheduleFrequency' &&
      controllerName !== 'employeeMapping'
    ) {
