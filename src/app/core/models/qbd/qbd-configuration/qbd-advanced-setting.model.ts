...
import type { QBDScheduleFrequency } from "../../enum/enum.model";

export interface QBDEmailOptions {
    name: string,
    email: string
}

export interface QBDAdvancedSettingsPost {
...
export interface QBDAdvancedSettingsGet {
    id: number,
    created_at: Date,
    updated_at: Date,
    expense_memo_structure: string[],
