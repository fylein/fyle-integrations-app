...
import { QBDCorporateCreditCardExpensesObject, QBDEntity, QBDExpenseGroupedBy, QBDExpenseState, QBDExportDateType, QBDReimbursableExpensesObject } from "../../enum/enum.model";

export type QBDExportSettingFormOption = {
    label: string,
    value: QBDExpenseState | QBDReimbursableExpensesObject | QBDCorporateCreditCardExpensesObject | QBDExportDateType | QBDExpenseGroupedBy;
}
...
export class ExportSettingModel {
    static constructPayload(exportSettingsForm: FormGroup): QBDExportSettingPost {
      const exportSettingPayload: QBDExportSettingPost = {
            ...
            reimbursable_expense_date: exportSettingsForm.get('reimbursableExpenseDate')?.value ? exportSettingsForm.get('reimbursableExportDate')?.value : null,
            ...
            credit_card_expense_date: exportSettingsForm.get('cccExpenseDate')?.value ? exportSettingsForm.get('cccExportDate')?.value : null
      };
