        ...
        EMPLOYEE: [
          {
            ...
            value: NetsuiteReimbursableExpensesObject.EXPENSE_REPORT
          },
          {
            label: 'Journal Entry',
            value: NetsuiteReimbursableExpensesObject.JOURNAL_ENTRY
          }
        ],
        VENDOR: [
          {
            label: 'Bill',
            value: NetsuiteReimbursableExpensesObject.BILL
          },
          {
            label: 'Journal Entry',
            value: NetsuiteReimbursableExpensesObject.JOURNAL_ENTRY
