  ...
  static constructPayload(advancedSettingsForm: FormGroup): AdvancedSettingsPost {
    ...
    const advancedSettingPayload: AdvancedSettingsPost = {
      configurations: {
        ...
        auto_create_merchants_as_vendors: getFormValue('autoCreateMerchants')
          ? getFormValue('autoCreateMerchants')
          : false,
      ...
      workspace_schedules: {
        ...
        emails_selected: advancedSettingsForm.get('email')?.value
          ? this.formatSelectedEmails(advancedSettingsForm.get('email')?.value)
          : [],
