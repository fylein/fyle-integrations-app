...
export function constructPayload1(
  valueField: {
  ...
  return {
    ...
    values:
      ...
      valueField.condition1.field_name === 'report_title' ||
      valueField.condition1.type === 'BOOLEAN'
        ? valueField.value1
        : valueOption1,
    rank: 1,
...
export function constructPayload2(
  valueField: {
  ...
  return {
    ...
    values:
      ...
      valueField.condition2.field_name === 'report_title' ||
      valueField.condition2.type === 'BOOLEAN'
        ? valueField.value2
        : valueOption2,
    rank: 2,
    join_by: null,
