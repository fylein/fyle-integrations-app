...
xdescribe('SearchPipe', () => {
  ...
  it('SearchPipe Transform function check 2', () => {
    const value = [{value: 'FyleIntegrations'}, {value: 'Fyle'}, {value: 'Integrations'}, {value: 'QBD'}, {value: 'fyle-integration'}];
    const text1 = "Fyle";
    const result1 = [{value: 'FyleIntegrations'}, {value: 'Fyle'}, {value: 'fyle-integration'}];
    const pipe1 = new SearchPipe();
    expect(pipe1.transform(value, text1)).toEqual(result1);
    const names = [{name: 'FyleIntegrations'}, {name: 'Fyle'}, {name: 'Integrations'}, {name: 'QBD'}, {name: 'fyle-integration'}];
    const text2 = "Fyle";
    const result2 = [{name: 'FyleIntegrations'}, {name: 'Fyle'}, {name: 'fyle-integration'}];
    const pipe2 = new SearchPipe();
  ...
  it('SearchPipe Transform function check 3', () => {
    ...
    const names2 = [{name: 'FyleIntegrations'}, {name: 'Fyle'}, {name: 'Integrations'}, {name: 'QBD'}, {name: 'fyle-integration'}];
    const text2 = "wFylesw";
