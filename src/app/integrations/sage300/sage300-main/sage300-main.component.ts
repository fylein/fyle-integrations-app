...
export class Sage300MainComponent {
  ...
  constructor(
    ...
    this.modules = [
      {
        label: this.translocoService.translate('sage300Main.dashboard'),
        routerLink: '/integrations/sage300/main/dashboard',
        value: 'dashboard',
      },
      {
        label: this.translocoService.translate('sage300Main.exportLog'),
        routerLink: '/integrations/sage300/main/export_log',
        value: 'export_log',
      },
      {
        label: this.translocoService.translate('sage300Main.mapping'),
        routerLink: '/integrations/sage300/main/mapping',
        value: 'mapping',
      },
      {
        label: this.translocoService.translate('sage300Main.configuration'),
        routerLink: '/integrations/sage300/main/configuration',
        value: 'configuration',
      },
    ];
  }
