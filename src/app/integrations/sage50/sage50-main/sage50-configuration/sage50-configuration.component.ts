...
export class Sage50ConfigurationComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.modules = [
      { label: this.translocoService.translate('sage50Configuration.exportSettings'), routerLink: '/integrations/sage50/main/configuration/export_settings', value: 'export_settings' },
