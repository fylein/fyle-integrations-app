...
import {
  BusinessCentralAccountingExport,
  BusinessCentralAccountingExportResponse,
} from 'src/app/core/models/business-central/db/business-central-accounting-export.model';
...
export class BusinessCentralDashboardComponent implements OnInit, OnDestroy {
  ...
  readonly accountingExportType: BusinessCentralExportType[] = [
    BusinessCentralExportType.PURCHASE_INVOICE,
    BusinessCentralExportType.JOURNAL_ENTRY,
  ];
  ...
  private pollExportStatus(exportableAccountingExportIds: number[] = []): void {
    interval(3000)
      .pipe(
        ...
        takeWhile(
          (response: BusinessCentralAccountingExportResponse) =>
  ...
  private setupPage(): void {
    forkJoin([
      ...
      const queuedTasks: BusinessCentralAccountingExport[] = responses[2].results.filter(
        (accountingExport: BusinessCentralAccountingExport) =>
