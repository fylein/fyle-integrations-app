...
import {
  QBOEmployeeSettingGet,
  QBOEmployeeSettingPost,
} from 'src/app/core/models/qbo/qbo-configuration/qbo-employee-setting.model';
import {
...
export const mockExportSettings = {
  ...
  expense_group_settings: {
    reimbursable_expense_group_fields: ['fund_source', 'expense_id', 'employee_email', 'spent_at'],
...
export const mockWorkspaceGeneralSettings = {
  ...
  memo_structure: ['employee_email', 'purpose', 'category', 'spent_on', 'report_number', 'expense_link'],
  auto_map_employees: AutoMapEmployeeOptions.NAME,
...
export const mockExportSettingSaveResponse = {
  ...
  expense_group_settings: {
    reimbursable_expense_group_fields: ['employee_email', 'fund_source', 'expense_id', 'spent_at'],
    corporate_credit_card_expense_group_fields: [
      'claim_number',
      'employee_email',
      'fund_source',
...
export const mockQboAdvancedSettings = {
  workspace_general_settings: {
    ...
    memo_structure: ['employee_email', 'merchant', 'purpose', 'category', 'spent_on', 'report_number', 'expense_link'],
  },
  general_mappings: {
  ...
  workspace_schedules: {
    ...
    emails_selected: ['admin1@fylefororion.fyle.in', 'owner@fylefororion.fyle.in'],
...
export const mockAdditionalEmails = [{ name: 'Additional User', email: 'additional@example.com' }];
...
export const mockExportableExpenseGroup = {
  exportable_expense_group_ids: [8087, 8088, 8089, 8090, 8091, 8092, 8093, 8094, 8095],
};

export const mockExportSettingsforDashboard = {
  expense_group_settings: {
    reimbursable_expense_group_fields: ['employee_email', 'cost_center', 'fund_source', 'expense_id'],
          ...
          Line: [
            {
              ...
              Description:
                'user6@fyleforgotham.in - Office Party - 2021-04-12 - C/2021/04/R/47 -  - https://staging1.fyle.tech/app/admin/#/enterprise/view_expense/txtxDAMBtJbP?org_id=or79Cob97KSh',
    ...
    },
    {
      ...
      response_logs: {
        ...
        Purchase: {
          ...
          Line: [
            {
              ...
              DetailType: 'AccountBasedExpenseLineDetail',
              Description:
                'user6@fyleforgotham.in - Unspecified - 2021-03-09 - C/2021/04/R/46 - DUNKIN #3513 (Card Transaction) - https://staging1.fyle.tech/app/admin/#/enterprise/view_expense/txT4JbfgtooE?org_id=or79Cob97KSh',
              AccountBasedExpenseLineDetail: {
                AccountRef: {
          ...
          PaymentType: 'CreditCard',
          PrivateNote:
            'Credit card expense by user6@fyleforgotham.in spent on merchant STEAK-N-SHAKE#0664 on 2021-03-09',
        },
      },
      employee_name: 'Victor Martinez',
    ...
    },
    {
      ...
      response_logs: {
        ...
        Bill: {
          ...
          Line: [
            {
              ...
              DetailType: 'AccountBasedExpenseLineDetail',
              Description:
                'user7@fyleforgotham.in - Office Supplies - 2021-05-15 - C/2021/05/R/48 - Office Supplies Inc. - https://staging1.fyle.tech/app/admin/#/enterprise/view_expense/txAB5678efgh?org_id=or79Cob97KSh',
              AccountBasedExpenseLineDetail: {
                AccountRef: {
          ...
          CustomField: [],
          PrivateNote:
            'Reimbursable expense by user7@fyleforgotham.in spent on vendor Office Supplies Inc. on 2021-05-15',
        },
      },
      employee_name: 'Alice Johnson',
