...
export class QboOnboardingAdvancedSettingsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.onboardingSteps = this.qboOnboardingService.getOnboardingSteps(this.translocoService.translate('configuration.advancedSettings.stepName'), this.workspaceService.getOnboardingState());
  }
