...
export class QboConfigurationComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.modules = [
      { label: this.translocoService.translate('configuration.exportSetting.stepName'), routerLink: '/integrations/qbo/main/configuration/export_settings', value: 'export_settings' },
