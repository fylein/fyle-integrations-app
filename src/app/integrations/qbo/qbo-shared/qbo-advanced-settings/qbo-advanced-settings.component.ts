...
export class QboAdvancedSettingsComponent implements OnInit {
    ...
    this.advancedSettingsService.postAdvancedSettings(advancedSettingPayload).subscribe(
      () => {
        ...
        this.toastService.displayToastMessage(
          ...
          this.translocoService.translate('qboAdvancedSettings.advancedSettingsSuccess'),
          undefined,
          this.isOnboarding,
        );
      ...
      () => {
        ...
        this.toastService.displayToastMessage(
          ToastSeverity.ERROR,
          this.translocoService.translate('qboAdvancedSettings.advancedSettingsError'),
        );
      },
    );
  }
  ...
  isAutoCreateVendorsFieldVisible(): boolean {
    return (
      this.workspaceGeneralSettings.employee_field_mapping === EmployeeFieldMapping.VENDOR &&
      ...
      (this.workspaceGeneralSettings.reimbursable_expenses_object === QBOReimbursableExpensesObject.BILL ||
  ...
  isSingleCreditLineJEFieldVisible(): boolean {
    return (
      this.workspaceGeneralSettings.reimbursable_expenses_object === QBOReimbursableExpensesObject.JOURNAL_ENTRY ||
  ...
  isAutoCreateMerchantsAsVendorsFieldVisible(): boolean {
    return (
      ...
      (this.workspaceGeneralSettings.corporate_credit_card_expenses_object ===
        ...
        this.workspaceGeneralSettings.name_in_journal_entry === NameInJournalEntry.MERCHANT)
    );
  }
  ...
  private getSettingsAndSetupForm(): void {
    ...
    forkJoin([
      ...
      ([
        sage300AdvancedSettingResponse,
        expenseFiltersGet,
        ...
        this.billPaymentAccounts = billPaymentAccounts.BANK_ACCOUNT.map((option: DestinationAttribute) =>
