...
export class QboImportSettingsComponent implements OnInit {
  ...
  updateImportCodeFieldConfig() {
    if (
      ...
      this.qboImportCodeFieldCodeConfig[DefaultImportFields.ACCOUNT]
    ) {
    ...
    this.importSettingService.postImportSettings(importSettingPayload).subscribe(
      () => {
        ...
        this.toastService.displayToastMessage(
          ...
          this.translocoService.translate('qboImportSettings.importSettingsSuccess'),
          undefined,
          this.isOnboarding,
        );
      ...
      () => {
        ...
        this.toastService.displayToastMessage(
          ToastSeverity.ERROR,
          this.translocoService.translate('qboImportSettings.importSettingsError'),
        );
      },
    );
  }
      ...
      if (!isImportCategoriesEnabled) {
        ...
        this.importSettingForm.controls.importCategoryCode.setValue(
          this.importSettingService.getImportCodeField(
            this.importSettings.workspace_general_settings.import_code_fields,
            DefaultImportFields.ACCOUNT,
            this.qboImportCodeFieldCodeConfig,
          ),
        );
      }
      if (isImportCategoriesEnabled) {
  ...
  private setupPage(): void {
    ...
    forkJoin([
      ...
      ([
        ...
        this.taxCodes = taxCodes.map((option: DestinationAttribute) =>
        ...
        this.fyleFields.push({
          ...
          display_name: this.translocoService.translate('qboImportSettings.createCustomField'),
          is_dependent: false,
        });
        this.updateImportCodeFieldConfig();
