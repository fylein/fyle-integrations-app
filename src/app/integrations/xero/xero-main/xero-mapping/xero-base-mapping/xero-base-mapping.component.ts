...
export class XeroBaseMappingComponent implements OnInit {
    ...
    this.mappingService.triggerAutoMapEmployees().subscribe(
      () => {
        ...
        this.toastService.displayToastMessage(
          ToastSeverity.INFO,
          this.translocoService.translate('xeroBaseMapping.autoMappingInfo'),
        );
      },
      () => {
        this.isLoading = false;
        this.toastService.displayToastMessage(
          ToastSeverity.ERROR,
          this.translocoService.translate('xeroBaseMapping.autoMappingError'),
        );
      },
    );
  }
  ...
  private getDestinationField(
    workspaceGeneralSetting: XeroWorkspaceGeneralSetting,
  ...
  private setupPage(): void {
    ...
    forkJoin([this.workspaceService.getWorkspaceGeneralSettings(), this.mappingService.getMappingSettings()]).subscribe(
      (responses) => {
