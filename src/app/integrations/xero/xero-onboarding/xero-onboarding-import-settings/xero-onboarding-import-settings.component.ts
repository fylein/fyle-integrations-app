...
export class XeroOnboardingImportSettingsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.onboardingSteps = this.xeroOnboardingService.getOnboardingSteps(this.translocoService.translate('xero.configuration.importSetting.stepName'), this.workspaceService.getOnboardingState());
  }
