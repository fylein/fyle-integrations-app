    ...
    this.modules = [
      {
        ...
        routerLink: '/integrations/intacct/main/configuration/export_settings',
        value: 'export_settings',
      },
      {
        label: this.translocoService.translate('configuration.importSetting.stepName'),
        routerLink: '/integrations/intacct/main/configuration/import_settings',
        value: 'import_settings',
      },
      {
        label: this.translocoService.translate('configuration.advancedSettings.stepName'),
        routerLink: '/integrations/intacct/main/configuration/advanced_settings',
