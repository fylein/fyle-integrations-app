...
export const mockExportSettingGet: ExportSettingGet = {
  ...
  expense_group_settings: {
    reimbursable_expense_group_fields: ['claim_number', 'employee_email', 'fund_source', 'report_id'],
...
export const mockConfiguration = {
  ...
  import_code_fields: ['_EXPENSE_TYPE', '_ACCOUNT'],
...
export const mockDimensionDetailsForFyleFields = {
  results: [{ attribute_type: 'PROJECT', display_name: 'Project Display Name', source_type: 'FYLE' }],
};
...
export const importSettingsWithProjectMapping = {
  ...importSettings,
  mapping_settings: [
    {
...
export const settingsWithDependentFields = {
  ...importSettings,
...
export const advancedSettings = {
  workspace_schedules: {
    ...
    additional_email_options: [{ name: 'Additional User', email: 'additional.user@example.com' }],
  },
  configurations: {
