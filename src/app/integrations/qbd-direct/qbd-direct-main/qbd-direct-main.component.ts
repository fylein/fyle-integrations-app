...
export class QbdDirectMainComponent {
  ...
  constructor(
    ...
    this.modules = [
      {
        label: this.translocoService.translate('qbdDirectMain.dashboard'),
        routerLink: '/integrations/qbd_direct/main/dashboard',
        value: 'dashboard',
      },
      {
        label: this.translocoService.translate('common.exportLogTabName'),
        routerLink: '/integrations/qbd_direct/main/export_log',
        value: 'export_log',
      },
      {
        label: this.translocoService.translate('qbdDirectMain.mapping'),
        routerLink: '/integrations/qbd_direct/main/mapping',
        value: 'mapping',
      },
      {
        label: this.translocoService.translate('qbdDirectMain.configuration'),
        routerLink: '/integrations/qbd_direct/main/configuration',
        value: 'configuration',
      },
    ];
  }
