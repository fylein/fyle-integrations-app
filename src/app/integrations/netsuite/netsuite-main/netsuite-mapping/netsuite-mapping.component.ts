...
export class NetsuiteMappingComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.mappingPages = [
      {
        label: this.translocoService.translate('netsuiteMapping.employee'),
        routerLink: '/integrations/netsuite/main/mapping/employee',
        value: 'employee',
      },
      {
        label: this.translocoService.translate('netsuiteMapping.category'),
        routerLink: '/integrations/netsuite/main/mapping/category',
        value: 'category',
      },
    ];
    this.setupPage();
