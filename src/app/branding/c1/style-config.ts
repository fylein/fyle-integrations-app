export const c1Styles = {
    ...
    dashboard: {
        ...
        exportSummaryViewText: 'link tw-text-text-primary tw-font-400 !tw-no-underline',
        ...
        exportErrorSubTextContainer: 'tw-rounded-4-px tw-py-8-px tw-px-12-px tw-bg-bg-tertiary-lighter',
    ...
    buttons: {
        primary: {
           ...
           disabled: 'tw-bg-bg-tertiary !tw-text-text-disable tw-cursor-not-allowed',
           progress: 'tw-bg-bg-tertiary tw-text-text-disable tw-cursor-not-allowed',
