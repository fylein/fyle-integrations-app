export const c1Styles = {
    ...
    dashboard: {
        ...
        exportSectionHeaderText: 'tw-ml-10-px tw-text-14-px tw-font-600 tw-text-text-primary',
        exportSectionDescriptionText: 'tw-ml-10-px tw-text-12-px tw-font-400 tw-text-sub-text-color',
