export const fyleStyles = {
  ...
  configuration: {
    ...
    infoLabelBackground:
      'tw-py-8-px tw-px-16-px tw-border tw-rounded-6-px tw-bg-bg-tertiary-lighter tw-border-separate',
    ...
    configurationAdvancedSettingCustomizationCardBody:
      'tw-mt-12-px tw-border tw-border-solid tw-border-separator tw-rounded-12-px',
    configurationAdvancedSettingNetsuiteCardBody:
      'tw-rounded-12-px tw-border-border-tertiary tw-border tw-bg-white tw-mb-16-px',
  ...
  dashboard: {
    ...
    exportErrorSubTextContainer:
      'tw-border-solid tw-border-1-px tw-border-border-tertiary tw-rounded-8-px tw-p-24-px tw-bg-bg-tertiary-lighter',
    ...
    exportErrorCard:
      'tw-flex tw-justify-between tw-items-start tw-gap-4 tw-border-solid tw-border-1-px tw-border-border-tertiary tw-rounded-8-px tw-p-24-px',
  ...
  buttons: {
    primary: {
      ...
      active:
        'hover:tw-bg-bg-green tw-text-white tw-text-sm tw-bg-btn-primary-bg tw-border-3-px tw-border-transparent focus:tw-ring-[4px] focus:tw-ring-black focus:tw-border-border-focus',
    ...
    secondary: {
      ...
      active:
        'hover:tw-border-border-green hover:tw-bg-bg-green hover:tw-text-white tw-text-green-text-color tw-bg-white tw-border-mandatory-field-color focus:tw-border-3-px focus:tw-ring-[4px] focus:tw-ring-black focus:tw-border-border-focus',
