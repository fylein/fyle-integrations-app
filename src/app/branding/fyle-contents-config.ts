...
export const fyleContents = {
    qbd_direct: {
        ...
        configuration: {
            ...
            advancedSettings: {
                ...
                customizeSectionSubLabel: 'In this section, you can customize the data that you\'d like to export from ' + brandingConfig.brandName + ' to QuickBooks Desktop.',
                ...
                autoExportfrequencySubLabel: 'Set a frequency based on how often you want your expenses in ' + brandingConfig.brandName + ' to be exported to QuickBooks Desktop.',
                topLevelMemoStructureLabel: 'Customize the top-level memo field',
                topLevelMemoStructureSubLabel: 'Select the datapoints you\'d like to export to QuickBooks Desktop’s top-level memo field when exporting expenses from ' + brandingConfig.brandName + '.',
                memoStructureLabel: 'Customize the line-item level memo field',
                memoStructureSubLabel: 'Select the datapoints you\'d like to export to QuickBooks Desktop\’s line-item level memo field when exporting expenses from ' + brandingConfig.brandName + '.',
                ...
                skipExportSubLabel: 'Set up a conditional rule to selectively skip exporting certain expenses from ' + brandingConfig.brandName + ' to QuickBooks Desktop. ',
                autoCreateReimbursableEnitityLabel: 'Auto-create ' + brandingConfig.brandName + ' employees as ',
                autoCreateReimbursableEnititySubLabel: 'If an employee in ' + brandingConfig.brandName + ' has no corresponding record in QuickBooks Desktop, the integration will automatically create a ',
    ...
    xero: {
        ...
        configuration: {
            ...
            advancedSettings: {
                ...
                contentText: 'In this section, you can customize the integration based on your accounting requirements. ',
                topLevelMemoStructureLabel: 'Customize the top-level memo field',
                topLevelMemoStructureSubLabel: 'Select the datapoints you\'d like to export to Xero’s top-level memo field when exporting expenses from ' + brandingConfig.brandName + '.',
                memoStructureLabel: 'Customize the line-item level memo field',
                memoStructureSubLabel: 'Select the datapoints you\'d like to export to Xero\’s line-item level memo field when exporting expenses from ' + brandingConfig.brandName + '.',
                ...
                frequencySubLabel: 'Set a frequency based on how often you want your expenses in ' + brandingConfig.brandName + ' to be exported to Xero.',
                ...
                autoCreateVendorsSubLabel: 'While exporting reimbursable expenses from ' + brandingConfig.brandName + ', the integration will automatically create a vendor if a match does not exist in Xero already'
            }
        }
    },
    intacct: {
    ...
    configuration: {
        ...
        advancedSettings: {
            ...
            automationSubLabel: 'You can automate the export and sync of your data in this section.',
            scheduleSubLabel: 'Set up a schedule to frequently automate the export of expenses from ' + brandingConfig.brandName + ' to QuickBooks Online.',
            frequencySubLabel: 'Set a frequency based on how often you want your expenses in ' + brandingConfig.brandName + ' to be exported to QuickBooks Online.',
            otherPreferencesLabel: 'Other preferences',
            otherPreferencesSubLabel: 'Based on your preference, you can choose whether you want to create any new records in QuickBooks Online from ' + brandingConfig.brandName + '. (when there is no employee record found, or when the accounting period is closed)',
            accountingPeriodLabel: 'Post entries in the current accounting period',
    ...
    exportLog: {
        ...
        completeExportLogCountZeroStateSubHeaderText: 'All your successful exports and their details will be stored here.',
        ...
        skipExportLogCountZeroStateSubHeaderText: 'All your expenses that were skipped from exporting will be stored here.'
